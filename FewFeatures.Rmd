...
#model = xgb.cv(params, X, 3000,nfold=4,metrics={'auc'}, seed = 0) #Found that 181 rounds gave the lowest test-logloss
#model
model <- xgboost(data = X, params = params, nrounds = 181)
