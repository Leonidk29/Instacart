...
importance <- xgb.importance(colnames(X), model = model)
xgb.ggplot.importance(importance) + theme_bw() +theme(axis.text = element_text(size = 12))
print(importance)
str(importance)
...
ggplot(importance, aes(x=reorder(Feature,Importance), y=Importance))+
  ...
  coord_flip() +
  theme_minimal() + theme(legend.position="none") + ggtitle("Features Importance") +
...
ggplot(importance, aes(x=reorder(Feature,Cover), y=Cover))+
  ...
  coord_flip() +
  theme_minimal() + theme(legend.position="none") + ggtitle("Features Cover") +
...
ggplot(importance, aes(x=reorder(Feature,Frequency), y=Frequency))+
  ...
  coord_flip() +
  theme_minimal() + theme(legend.position="none") + ggtitle("Features Frequency") +
...
wordcloud(words = normalised$product_name, min.freq = 0,
